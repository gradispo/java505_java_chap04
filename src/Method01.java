...
//        2. 매개변수는 존재하고 반환값은 없는 형태
    public static void subType2(int a, int b) { // void = 반환될게 없다
        int result = a - b;
...
//        return 키워드 사용 시 반환되는 값의 데이터 타입은 해당 메서드의 반환 타입과 일치해야 함
    public static int multiType3() { // return 되돌려주는 값이 = int
        int a = 10;
        int b = 20;
        int result = a * b;
        return result;
...
//        4. 매개변수와 반환값이 모두 존재하는 형태
    public static double divType4(int a, int b) { // 실수형으로 리턴하고 싶다면, int를 double로 수정
        double result = a / b;
        return result;
    }
