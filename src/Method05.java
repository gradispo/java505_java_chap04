...
public class Method05 {
    ...
    public static void inCall() {
        System.out.println("Method05 클래스의 맴버 메서드");
    }
//    프로그램을 실행하기 위한 main 메서드가 존재
    public static void main(String[] args) {
//        메소드 호출하기
//        1. 클래스 내부 호출 : 동일한 클래스의 맴버끼리 호출하는 것
//        2. 클래스 외부 호출 : 다른 클래스의 객체를 생성하고 해당 객체의 맴버를 호출

        inCall(); // 클래스 내부 호출

//        Car2 avante = new Car2(); // Car2.class
...
//        생성자 : 지정한 클래스를 기반으로 객체를 생성
        ...
        avante = new Car2(); // Car2클래스 객체가 생성되고 Car2 클래스 타입의 변수 대입되어 사용준비가 완료 됨

//        클래스 외부 호출
//        avante 객체의 맴버 run, stop, sound
        avante.name = "아반테";
        avante.run();
        avante.stop();
        avante.sound();
