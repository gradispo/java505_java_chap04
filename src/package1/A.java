...
//
////    접근제한자가 public(모두 접근가능)인 생성자를 사용하여 객체 생성
//    A a1 = new A(true);
////    접근제한자가 default(동일한 패키지 접근가능/다른 패키지 접근불가)인 생성자를 사용하여 객체 생성
//    A a2 = new A(1);
////    접근제한자가 private(클래스 내부에서만 사용가능)인 생성자를 사용하여 객체 생성
//    A a3 = new A("문자열");
//
////    생성자
////    접근제한자가 public 인 생성자
...
//    public을 사용하여 외부에서 모두 접근 가능
    public int value1;
//    defaut를 사용하여 동일한 패키지 내에서만 접근 가능
    int value2;
